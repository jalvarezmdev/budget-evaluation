...
const alertVariants = cva('relative w-full rounded-xl border p-4 [&>svg~*]:pl-7', {
  variants: {
    variant: {
      default: 'border-white/10 bg-secondary/60 text-foreground',
      destructive: 'border-destructive/45 bg-destructive/10 text-red-200'
    }
  },
  defaultVariants: {
    variant: 'default'
